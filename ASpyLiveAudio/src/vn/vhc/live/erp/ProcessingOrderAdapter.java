...
public class ProcessingOrderAdapter  extends ArrayAdapter<Products> {
	...
	public ProcessingOrderAdapter(Activity context,
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if (convertView == null) {
			...
			convertView = inflater.inflate(R.layout.processing_order, parent,
					false);
	...
	public void MyclickItem(int postion){
		final Dialog dialog = new Dialog(mcontext);
		dialog.setContentView(R.layout.dialog_listproducts);
		dialog.setTitle("Danh sách sản phẩm");
		ListView listView=(ListView)dialog.findViewById(R.id.grid_order_products);
		OrderProductsListAdapter orderProductsListAdapter = new OrderProductsListAdapter(mcontext,R.layout.order_products_item,original.get(postion).prdoucts);
		listView.setAdapter(orderProductsListAdapter);
