...
public class SpinerApdater extends ArrayAdapter<String> {
	...
	public SpinerApdater(Activity context, int textViewResourceId,
			String[] spinnerSubs, String[] spinnerValues, int index,
			String controlName) {
	...
	public View getCustomView(int position, View convertView, ViewGroup parent) {
		...
		if (convertView == null) {
			...
			convertView = infalater.inflate(R.layout.custom_spiner, parent,
					false);
		//	holder.main_text = (TextView) convertView
			//		.findViewById(R.id.text_main_seen);
			holder.subSpiner = (TextView) convertView
